...
{
    MTRefreshBackNormalFooter* footer = [super footerWithRefreshingTarget:target refreshingAction:action];
    [footer setupSubView];
...
{
    MTRefreshBackNormalFooter* footer = [super footerWithRefreshingBlock:refreshingBlock];
    [footer setupSubView];
