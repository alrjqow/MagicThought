...
- (void)setModel:(TZAssetModel *)model {
    ...
    if([TZImageManager manager].isFocusSelected)
        model.isSelected = [[TZImageManager manager].assetIdentifierDict[self.representedAssetIdentifier] isExist];    
...
-(void)setDidSelectPhotoBlock:(void (^)(BOOL))didSelectPhotoBlock
{
    _didSelectPhotoBlock = didSelectPhotoBlock;
    
    if([TZImageManager manager].isFocusSelected && [[TZImageManager manager].assetIdentifierDict[self.representedAssetIdentifier] isExist])
        didSelectPhotoBlock(false);
}
